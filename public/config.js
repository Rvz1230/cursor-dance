(function cursorDanceDefaultConfig() {
  ...
  const defaultThemePackDefinitions = [
    ...
    },
    {
      id: "mimo-orbit",
      name: "MiMo Orbit",
      description: "粒子星云环绕鼠标，光影跟随，适配创意展示场景。",
      kind: "builtin",
      cursorStates: createDefaultCursorStates(),
      workbenchDraft: {
        actionConfigs: {
          leftClick: {
            ...
            particleGravity: 0,
            particlePalette: ["#8B5CF6","#A78BFA","#C4B5FD","#7C3AED","#6D28D9"],
            sound: true,
            volume: 60,
            shake: 20,
            cursorOverride: "跟随当前状态",
    ...
    },
    {
      id: "creative-mouse",
      name: "Creative Mouse",
      description: "双圆点光标配合元素磁吸，适合设计稿展示和交互演示。",
      kind: "builtin",
      cursorStates: createDefaultCursorStates(),
      workbenchDraft: {
        actionConfigs: {
          leftClick: {
            ...
            particleGravity: 4,
            particlePalette: ["#06B6D4","#0891B2","#22D3EE","#67E8F9","#A5F3FC"],
            sound: true,
            volume: 55,
            shake: 16,
            cursorOverride: "跟随当前状态",
        ...
        atmosphere: { mode: "creative-mouse" },
      },
    },
  ];
