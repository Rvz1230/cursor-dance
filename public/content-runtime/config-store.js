(function registerContentConfigStore(globalThis) {
  ...
  modules.createConfigStore = function createConfigStore(runtime) {
    ...
    function resolveCursorStateId(target) {
      ...
      var cursorValue = window.getComputedStyle(target).cursor || "";
      var stateId;
      ...
      else if (cursorValue === "move" || cursorValue === "copy" || cursorValue === "alias" || cursorValue === "cell" || cursorValue === "all-scroll" || cursorValue === "crosshair" || cursorValue === "context-menu") stateId = "pointer";
      else if (cursorValue === "zoom-in" || cursorValue === "zoom-out") stateId = "pointer";
      else if (cursorValue.endsWith && cursorValue.endsWith("-resize")) stateId = "pointer";
    ...
    function debouncedSyncConfigFromStorage(opts) {
      if (syncTimer) window.clearTimeout(syncTimer);
      syncTimer = window.setTimeout(function () {
        syncTimer = null;
        syncConfigFromStorage(opts);
      }, 60);
    }
