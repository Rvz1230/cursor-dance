  ...
  return (
    <header className="border-b border-slate-200 bg-white">
      <div
        ...
        style={DRAG_STYLE}
      >
        {/* 品牌区 + workspace tabs：可拖拽区域，但 tabs 自身 no-drag */}
        ...
        <div
          className="flex min-w-0 flex-1 items-center gap-2 overflow-x-auto px-2 py-1"
          style={NO_DRAG_STYLE}
        >
        ...
        >
          ...
          <div className="hidden h-7 items-center gap-2 rounded-xl bg-slate-50 px-2.5 text-xs text-slate-600 xl:flex">
          ...
          <Button variant="outline" className="h-7 px-2.5 text-xs" onClick={resetCurrentTheme}>
        ...
        {/* 非 macOS：自绘窗口控制按钮（minimize / maximize / close）。
            macOS 下系统已渲染红绿灯，不需要重复。*/}
        {!isMac && bridge ? (
          <div className="flex shrink-0 items-stretch" style={NO_DRAG_STYLE}>
            <WindowControlButton
              ariaLabel="最小化"
